...
gFile="audio_cloverALC-120.command_v1.0b0"
# gFile="audio_pikeralphaALC-120.command_v1.0a01"
...
# v1.0b0 - 8/7/16: KextTo Patch fix, credit: werner77

echo " "
echo "Agreement"
echo "The audio_cloverALC-120 script is for personal use only. Do not distribute" 
echo "the patch, any or all of the files or the resulting patched AppleHDA.kext" 
echo "for any reason without permission. The audio_cloverALC-120 script is" 
